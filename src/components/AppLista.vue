  ...
  <div class="col px-3">
    ...
    <div class="lista p-0 container-fluid">
      ...
      >
        ...
        <div class="col-2 align-items-center">{{ prod.user }}</div>

        <div class="div col-3 align-items-center">
          <button
            v-on:click="sumarProducto(prod)"
            type="button"
            class="btn btn-sm"
          >
            <svg
          ...
          <button
            v-on:click="restarProducto(prod)"
            type="button"
            class="btn btn-sm"
          >
            <svg
